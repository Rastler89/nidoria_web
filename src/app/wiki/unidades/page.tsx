...
const unidades: Unidad[] = [
    {
        ...
        tecnica: "<b>Técnica de Combate</b>: Su arma principal no es la mordida o el aguijón, sino la potente secreción de su glándula abdominal.",
        ...
        impacto: "<b>Impacto Ambiental</b>: Son arquitectas increíbles. Sus colonias construyen enormes montículos con agujas de pino y tierra, que pueden alcanzar varios metros de altura, usándolos como una fortaleza solar. En el juego, esto simboliza la organización y el apoyo logístico detrás de esta unidad.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Su estrategia se llama autotisis. Estas hormigas obreras tienen glándulas mandibulares extremadamente grandes que se extienden por casi todo su cuerpo. Están llenas de una secreción defensiva pegajosa y tóxica.",
        ...
        impacto: "<b>Costo y Valor</b>: Su bajo PV refleja su naturaleza inherentemente frágil y su destino: estas unidades no están destinadas a sobrevivir a un enfrentamiento. Su alto ATQ y efecto de área al morir representan la gran potencia de su carga química. El término 'Melosa' hace referencia a la sustancia interna que, aunque tóxica, es altamente viscosa y similar a un jarabe.",
        ...
        tecnica: "<b>Técnica de Combate</b>: A diferencia de muchas otras especies que solo muerden, las Solenopsis invicta utilizan sus mandíbulas para agarrar a la víctima y luego rotan su abdomen para inyectar repetidamente veneno con su aguijón.",
        ...
        impacto: "<b>Comportamiento Nómada</b>: Su nombre de unidad refleja su naturaleza invasora y colonizadora. Son maestras en formar balsas vivientes al entrelazarse cuando hay inundaciones, una demostración de resistencia y coordinación colectiva.",
        ...
        impacto: "<b>Agresividad y Tamaño</b>: Su alto PV y DEF, en comparación con otras unidades de artillería, reflejan el tamaño inusualmente grande y la naturaleza extremadamente territorial de estas hormigas.",
        ...
        impacto: "<b>Dualidad de Castas</b>: El nombre de la unidad se burla ligeramente de su función original (procesar semillas), reorientándola a una función militar: usar esa misma capacidad de trituración como un arma de asalto.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Cuando se sienten amenazadas, estas hormigas no solo muerden dolorosamente, sino que también rocían un chorro de ácido fórmico. Son menos precisas que el Avispero Ácido, pero la nube química tiene un efecto más irritante y desorientador.",
        ...
        impacto: "<b>Aspecto Único</b>: Su nombre de unidad y su bajo ATQ reflejan que su fuerza no está en el ataque directo, sino en la táctica de apoyo y defensa química, usando la secreción como un proyectil que confunde antes de dañar.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Algunas especies de Aphaenogaster son conocidas por utilizar elementos ambientales, como semillas de ciertas plantas que son inherentemente pegajosas, o incluso resinas defensivas, para manipular su entorno. En el juego, esta característica se exagera para crear un arma táctica.",
        ...
        impacto: "<b>Rol Táctico</b>: Su ATQ y DEF promedio indican que su valor no reside en el combate directo, sino en su capacidad para aplicar efectos de control de masas a distancia, manteniendo a raya a las amenazas más móviles.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Si bien estas hormigas son conocidas por sus poderosas picaduras y venenos que causan dolor intenso, su presencia constante en terrenos áridos y secos hace que constantemente muevan grandes cantidades de tierra y arena fina alrededor de la entrada de sus nidos.",
        ...
        impacto: "<b>Resistencia</b>: Su nombre de unidad 'Asedio' refleja su tenacidad en ambientes duros, mientras que sus estadísticas equilibradas de PV y DEF reflejan la dureza de su exoesqueleto.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Lasius niger, aunque pequeña, utiliza el ácido fórmico para defenderse y paralizar presas pequeñas. Su naturaleza oportunista y su habilidad para colonizar y moverse por túneles y grietas rápidamente se convierte en una ventaja táctica.",
        ...
        impacto: "<b>Movilidad y Fragilidad</b>: El balance de sus estadísticas refleja su naturaleza: es una unidad de cristal, que inflige gran daño si se usa para golpear y huir, pero sucumbe rápidamente si es capturada en combate.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Las hormigas guerreras son ciegas y dependen enteramente de las feromonas y el contacto físico. Atacan en masa, inmovilizando a sus presas con números abrumadores y potentes mordeduras. Los soldados mayores tienen mandíbulas descomunales.",
        ...
        impacto: "<b>Poder de la Mandíbula</b>: El alto ATQ refleja la fuerza de las mandíbulas de los soldados mayores de Dorylus, que son tan poderosas que en algunas culturas africanas se han utilizado para suturar heridas, actuando como grapas vivientes.",
        ...
        tecnica: "<b>Técnica de Combate</b>: A diferencia de la mayoría de las hormigas, que solo corren, estas hormigas pueden saltar distancias significativas (varios centímetros) tanto para atrapar presas como para escapar del peligro. Este salto es provocado por una rápida liberación de energía acumulada en sus patas.",
        ...
        impacto: "<b>Fisiología Única</b>: Sus estadísticas de PV y DEF moderados, junto con un ATQ sólido, reflejan que son cazadores competentes, aunque no están diseñados para resistir una pelea de desgaste.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Estas hormigas tienen mandíbulas alargadas que se mantienen abiertas y se cierran con una fuerza y velocidad extremas, ¡alcanzando velocidades de hasta 230 km/h en solo 0.13 milisegundos! Utilizan este 'golpe de resorte' no solo para matar presas, sino también para impulsarse en el aire y saltar hacia atrás o hacia los lados para escapar de amenazas.",
        ...
        impacto: "<b>Función Doble</b>: El nombre 'Piquete' hace referencia a la función de su ataque, que no es solo morder, sino apuñalar o punzar con la punta de sus mandíbulas, capaces de perforar con fuerza.",
        ...
        impacto: "<b>Resistencia Frágil</b>: Sus estadísticas muy bajas de PV y DEF reflejan que, aunque son rápidas, son extremadamente vulnerables. Si son alcanzadas, caen inmediatamente. Su supervivencia depende totalmente de su velocidad.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Su estrategia real es la guerra de saturación. Simplemente abruman al enemigo con números. Su bajo nivel de agresión individual se compensa con la increíble densidad de población y la ausencia de luchas internas entre nidos.",
        ...
        impacto: "<b>Estadísticas Equilibradas</b>: Sus estadísticas son sólidas, pero no excepcionales, reflejando que su fuerza proviene de la capacidad de reemplazo, no de la habilidad de combate individual.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Su estrategia real es la incursión relámpago. Entran en masa en los nidos de otras especies, infunden pánico y roban pupas que eclosionarán como sus obreras 'esclavas'.",
        ...
        impacto: "<b>Estadísticas de Asesino</b>: Su alto ATQ y PV moderado reflejan que son guerreros natos, con mandíbulas en forma de hoz optimizadas únicamente para la lucha.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Su estrategia principal no es infligir daño físico con la mordida, sino liberar un potente y nauseabundo olor (una feromona defensiva) cuando se sienten amenazadas o aplastadas. Este hedor es suficiente para disuadir a muchos depredadores.",
        ...
        impacto: "<b>Naturaleza Invasora</b>: Su apodo de 'Saqueador' se debe a su capacidad para invadir y establecer colonias en casi cualquier lugar, incluyendo estructuras humanas, moviéndose constantemente y buscando oportunidades.",
        ...
        tecnica: "<b>Técnica de Combate</b>: En la naturaleza, las obreras de esta especie tienen una cabeza plana, en forma de disco, conocida como 'escarizada'. Cuando están dentro de su nido, utilizan esta cabeza para encajar perfectamente en la entrada del túnel, bloqueando físicamente el paso a los invasores.",
        ...
        impacto: "<b>Estadísticas de Tanque Ligero</b>: Su PV y DEF son los más altos en la clase Ligera, reflejando la dureza de su cabeza y su rol primario como muro defensivo temporal.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Si bien estas hormigas son agresivas y usan ácido fórmico, su fuerza principal radica en su vigilancia constante de su vasto territorio y montículo. Son expertas en la detección de intrusos y la localización de presas.",
        ...
        impacto: "<b>Equilibrio</b>: Sus estadísticas reflejan un luchador ligero pero competente, apto tanto para el ataque como para la exploración.",
        ...
        impacto: "<b>Fragilidad vs. Letalidad</b>: Su bajo PV/DEF se compensa con un alto ATQ y la capacidad táctica de su veneno de zona, enfatizando la naturaleza de 'golpear y correr'.",
        ...
        tecnica: "<b>Técnica de Combate</b>: En la naturaleza, las Atta Majors utilizan sus mandíbulas no solo para cortar sino para la defensa, ya que son demasiado grandes para realizar otras tareas. Su exoesqueleto es excepcionalmente grueso.",
        ...
        impacto: "<b>Estadísticas de Tanque</b>: Su altísimo PV y DEF son un testimonio de su resistencia, a pesar de tener un ATQ moderado, reflejando su función principal de absorción de daño. El 'cuerno' del nombre se refiere a las protuberancias espinosas de su tórax, que aumentan su defensa.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Si bien en la naturaleza estas hormigas utilizan sus mandíbulas para manipular objetos, el juego exagera esta capacidad. Su fuerza principal no es la velocidad, sino el poder de palanca y trituración. Utilizan sus potentes mandíbulas para excavar rápidamente y debilitar la base de cualquier estructura.",
        ...
        impacto: "<b>Estadísticas de Asedio</b>: Su alto PV y ATQ reflejan su papel como atacante persistente y fuerte, capaz de resistir el fuego defensivo mientras machaca las fortificaciones.",
        ...
        tecnica: "<b>Técnica de Combate</b>: En la naturaleza, las Messor dedican gran parte de su tiempo a transportar cargas que superan con creces su propio peso, a menudo a través de terrenos difíciles y secos. Su anatomía está optimizada para la fuerza pura y la persistencia, no para la velocidad.",
        ...
        impacto: "<b>Equilibrio Robusto</b>: Sus estadísticas altas y equilibradas de PV, ATQ y DEF reflejan una unidad que puede luchar y resistir durante largos períodos de tiempo.",
        ...
        impacto: "<b>Invasión Masiva</b>: Aunque son unidades pesadas, su presencia constante y su disposición a luchar hasta la muerte las convierten en una fuerza imparable.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Si bien no son tan agresivas como otras especies, su gran tamaño y la fuerza de su mordida son formidables. En el juego, se enfatiza su capacidad de absorber golpes y devolver el impacto de manera que perturbe el ataque enemigo.",
        ...
        impacto: "<b>Estadísticas de Bloqueo</b>: Su PV es el más alto hasta ahora, y su DEF es excelente, reflejando su rol como la primera línea de defensa que debe aguantar el castigo.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Esta habilidad aérea las hace expertas en la llegada y el ataque inesperados. Pueden saltar o dejarse caer sobre un enemigo desde una posición elevada sin ser detectadas.",
        ...
        impacto: "<b>Mandíbulas de Sierra</b>: Su ATQ es sólido, ya que su cabeza, además de ser plana (útil para el planeo y la defensa), también está equipada con fuertes mandíbulas.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Su estrategia de combate combina una mordida poderosa con una picadura de veneno altamente potente y neurotóxico. Su gran tamaño y la construcción de nidos que involucran mover pequeñas rocas justifican el nombre de 'Golpeador de Roca'.",
        ...
        impacto: "<b>Agresividad y Resistencia</b>: Sus estadísticas reflejan una unidad más ofensiva que el Destructor de Cuernos, diseñada para infligir daño letal en la primera línea.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Su estrategia principal es la defensa posicional. Utilizan material circundante (barro, detritos) mezclado con sus secreciones para reforzar rápidamente su posición y construir barreras improvisadas.",
        ...
        impacto: "<b>Estadísticas Defensivas</b>: Su bajo ATQ se compensa con un PV muy alto y la capacidad de aumentar significativamente su DEF, confirmando su rol como tanque y constructor defensivo.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Estas obreras están tan hinchadas de 'miel' que son casi inmóviles. Aunque no son guerreros activos, su valor radica en lo que llevan dentro. Su defensa es alta por la tensión de su abdomen inflado, pero si son atacadas, el impacto es catastrófico, liberando su contenido.",
        ...
        tecnica: "<b>Técnica de Combate</b>: Son cazadores solitarios o pequeños grupos, pero su fuerza individual es inmensa. Su gran tamaño, su exoesqueleto duro y su veneno potente (la poneratoxina, que afecta al sistema nervioso) las hacen temibles.",
        ...
        impacto: "<b>Color Ébano</b>: Su nombre refleja su color negro brillante y su rol de muralla impenetrable.",
                        ...
                        {unidadesFiltradas.map((unidad) => (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-muted-foreground mb-6 text-sm leading-relaxed" dangerouslySetInnerHTML={{ __html: unidad.descripcion }} />
                                    <p className="text-muted-foreground mb-6 text-sm leading-relaxed" dangerouslySetInnerHTML={{ __html: unidad.tecnica }} />
                                    <p className="text-muted-foreground mb-6 text-sm leading-relaxed" dangerouslySetInnerHTML={{ __html: unidad.impacto }} />

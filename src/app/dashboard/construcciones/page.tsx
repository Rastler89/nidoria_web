                ...
                <CardContent className="space-y-4">
                  {activeConstructions.map((c: any) => (
                    < div
                      ...
                      className={`tech-node p-6 cursor-pointer transition-all hover:bg-accent/5 ${selectedBuilding === c.construction.id ? "ring-2 ring-primary bg-accent/10" : "bg-card/50"
                        }`}
                      onClick={() => setSelectedBuilding(c.construction.id)}
                    >
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
                        ...
                        <div className="text-right flex flex-col items-end gap-1">
                          {c.construction.upgrading && <Badge className="bg-yellow-500/80 text-white animate-pulse">⚡ Mejorando</Badge>}
                        </div>
                      </div>
